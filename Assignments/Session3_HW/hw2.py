...
number = int(num)
while True:
    number_for_left = number % 10
    number_for_right = ((number // 10) + (number % 10)) % 10
    number_combined = (10 * number_for_left) + number_for_right
    cycle += 1
    if number_combined == int(num):
        print(cycle)
        break
    else:
        number = number_combined