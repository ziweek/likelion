...
urlpatterns = [
    ...
    path('editMajor/<int:pk>', views.EditMajorView.as_view(), name='editMajor'),
    path('editSubject/<int:pk>', views.EditSubjectView.as_view(), name='editSubject'),
    ...
    path('business/', views.businsessView, name='business'),
]
